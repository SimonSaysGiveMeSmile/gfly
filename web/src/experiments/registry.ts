...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    number: "10",
    title: "Golf",
    tagline: "Five putting holes on a green with slopes to read.",
    summary:
      "A green in the garden at the fly's own scale, a tilt and a few mounds per hole, five holes, fewest strokes wins. The ball rolls down the gradient under scaled gravity and against the grass. The fly reads the green by trying lines either side of the cup in the same physics you see; with its brain on, the connectome chooses among them and learns from where the ball finished.",
    status: "live",
  ...
  },
  {
    ...
    number: "11",
    title: "Tennis",
    tagline: "A short set on a hard court in the garden.",
    summary:
      "A hard court in the garden at the fly's own scale. Each shot names a spot and a pace; the engine finds the launch, adds the hitter's error, and flies the ball under gravity over or into the net to its bounce. Whoever cannot reach the top of the bounce in time has lost the point. Real scoring, serves and second serves. The fly weighs the open court, behind you, a drop and the middle; with its brain on, the connectome chooses and learns from the point.",
    status: "live",
