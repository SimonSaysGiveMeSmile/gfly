    ...
    <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
      <section className="grid gap-8 py-16 lg:grid-cols-12 lg:py-24">
        <div className="lg:col-span-7">
          ...
          <h1 className="t-large rise mt-5" style={{ animationDelay: "60ms" }}>
            A real fly brain,<br />running in your browser.
          </h1>
          <p className="t-body rise mt-6 max-w-xl" style={{ animationDelay: "120ms" }}>
        ...
        <div className="lg:col-span-5">
          <div className="glass rise p-6" style={{ animationDelay: "240ms" }}>
