  ...
  return (
    <article className="mx-auto max-w-[900px] px-6 py-16 lg:px-10">
      ...
      <div className="t-body mt-6 space-y-5">
        ...
        <h2 className="t-title pt-4 text-label">What is real here</h2>
        ...
        <h2 className="t-title pt-4 text-label">Adding an experiment</h2>
        <p>
        ...
        <h2 className="t-title pt-4 text-label">Credit</h2>
        <p>
